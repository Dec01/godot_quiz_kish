...
func shut1():
	...
	$episod4/workstate/shut_icon.visible = true
	var animation_list = $episod4/shut_go1.get_animation_list()
	var random_animation = animation_list[data_rand]
	$episod4/shut_go1.play(random_animation)
	
func shut2():
	var data_rand = random_shut()
	$episod4/workstate/shut_icon2.visible = true
	var animation_list = $episod4/shut_go2.get_animation_list()
	var random_animation = animation_list[data_rand]
	$episod4/shut_go2.play(random_animation)
	
func shut3():
	var data_rand = random_shut()
	$episod4/workstate/shut_icon3.visible = true
	var animation_list = $episod4/shut_go3.get_animation_list()
	var random_animation = animation_list[data_rand]
	$episod4/shut_go3.play(random_animation)

func shut4():
	var data_rand = random_shut()
	$episod4/workstate/shut_icon4.visible = true
	var animation_list = $episod4/shut_go4.get_animation_list()
	var random_animation = animation_list[data_rand]
	$episod4/shut_go4.play(random_animation)


# Called when the node enters the scene tree for the first time.
func _ready():
	Global.shut_play = true
	Global.hronika_items = 0
	$"%finish".hide()
	if Global.zvuk == true:
		$episod4/workstate/menu_panel/zvuk2.pressed = false
	elif Global.zvuk == false:
		$episod4/workstate/menu_panel/zvuk2.pressed = true
...
func _on_shut_icon_pressed():
	...
	$episod4/workstate/shut_icon.visible = false
...
func _on_shut_icon2_pressed():
	...
	Global.hronika_items += 1
	get_node("%menu_panel2/%much_raund").text = str(Global.hronika_items)
	$episod4/workstate/shut_icon2.visible = false
...
func _on_shut_icon3_pressed():
	...
	Global.hronika_items += 1
	get_node("%menu_panel2/%much_raund").text = str(Global.hronika_items)
	$episod4/workstate/shut_icon3.visible = false
...
func _on_shut_icon4_pressed():
	...
	Global.hronika_items += 1
	get_node("%menu_panel2/%much_raund").text = str(Global.hronika_items)
	$episod4/workstate/shut_icon4.visible = false
